...
`,j=i.default.div.withConfig({componentId:"zh__sc-b0e7adc5-1"})`
  ...
  top: 4px;
  right: 4px;
`;function y({isHomePage:e}){let[n,i]=(0,r.useState)("");return(0,t.jsxs)(k,{children:[e&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(E,{children:(0,t.jsx)(p.Body1,{$weight:"BOLD",children:"사용자전환"})}),(0,t.jsx)(D,{children:(0,t.jsx)(p.Body1,{$weight:"BOLD",children:"챗봇"})}),(0,t.jsx)(T,{children:(0,t.jsx)(p.Body1,{$weight:"BOLD",children:"원격지원"})}),(0,t.jsx)(L,{children:(0,t.jsx)(p.Body1,{$weight:"BOLD",children:"음성알림"})}),(0,t.jsx)(M,{children:(0,t.jsx)(p.Body1,{$weight:"BOLD",children:"기관운영"})}),(0,t.jsx)(A,{onClick:()=>c.default.auth.logout(),children:(0,t.jsx)(p.Body1,{$weight:"BOLD",children:"로그아웃"})})]}),(0,t.jsx)(f.default.Text,{placeholder:"텍스트 입력...",value:n,valueSetter:i,decoration:"OUTLINE",style:1,state:"DEFAULT",size:{type:"FLEX",value:1},Icon:{Left:s.Search}}),(0,t.jsx)(b,{}),(0,t.jsx)(p.Body1,{$weight:"MEDIUM",children:"김요한 복지사"}),(0,t.jsx)(S,{children:(0,t.jsx)(a,{size:20,className:h.default.classname.CLICKABLE})})]})}let{SPACING:v,BORDER_RADIUS:_}=o.default.numeric,{PRIMARY:O,SECONDARY:z,GREEN:C,ORANGE:I,BLACK:$}=o.default.color,k=i.default.div.withConfig({componentId:"zh__sc-fea378dc-0"})`
  height: 64px;
  display: flex;
  align-items: center;
  gap: ${v.MEDIUM}px;

...
`,tN=n.default.input.withConfig({displayName:"Recipient__Input",componentId:"sc-30175ea4-21"})`
  ...
  border-radius: 4px;
`,tO=(0,t.observer)(function(){let{selectedRecipient:e,selectedMidNav:t}=d.default.recipient;return null===e?null:(0,i.jsxs)(tR,{children:[(0,i.jsx)(i9,{}),(0,i.jsx)(iK,{}),"BASIC_INFO"===t?(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(iC,{}),(0,i.jsx)(et,{}),(0,i.jsx)(G,{})]}):"DOCS_MANAGEMENT"===t?(0,i.jsx)(it,{}):"COUNSELING_LOG"===t?(0,i.jsx)(g,{}):null]})}),{SPACING:tL,BORDER_RADIUS:t$}=l.default.numeric,{BOX_SHADOW:tM}=l.default.text,tR=n.default.div.withConfig({displayName:"BasicInfo__Container",componentId:"sc-7e9bc087-0"})`
  flex: 1;
  min-width: 0;
  display: flex;
  flex-direction: column;
  padding: ${tL.MEDIUM}px;
  background-color: white;
  border-radius: ${t$}px;
  box-shadow: ${tM};
`;function tD(){return(0,i.jsx)(tE,{children:"Registration"})}let tE=n.default.div.withConfig({displayName:"Registration__Container",componentId:"sc-ee309da5-0"})``,tk=(0,t.observer)(function(){let{selectedTopNav:e}=d.default.recipient;return(0,i.jsx)(tT,{children:"BASIC_INFO"===e?(0,i.jsx)(tO,{}):"REGISTRATION"===e?(0,i.jsx)(tD,{}):null})}),{SPACING:tA}=l.default.numeric,tT=n.default.div.withConfig({displayName:"Content__Container",componentId:"sc-8f97136b-0"})`
  display: flex;
  justify-content: center;

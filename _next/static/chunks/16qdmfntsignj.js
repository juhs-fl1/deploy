...
`,s=(0,n.observer)(({children:e})=>{let{token:n}=r.default.auth;return n?e:(0,t.jsx)(l,{})});e.s(["default",0,s],48271)},33261,(e,t,n)=>{t.exports=e.r(40806)},73060,e=>{"use strict";var t=e.i(9735),n=e.i(33261),r=e.i(12235),i=e.i(65234),o=e.i(7744),l=e.i(4153);function a(){return(a=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}var d=(0,o.forwardRef)(function(e,t){var n=e.color,r=e.size,i=void 0===r?24:r,l=function(e,t){if(null==e)return{};var n,r,i=function(e,t){if(null==e)return{};var n,r,i={},o=Object.keys(e);for(r=0;r<o.length;r++)n=o[r],t.indexOf(n)>=0||(i[n]=e[n]);return i}(e,t);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);for(r=0;r<o.length;r++)n=o[r],!(t.indexOf(n)>=0)&&Object.prototype.propertyIsEnumerable.call(e,n)&&(i[n]=e[n])}return i}(e,["color","size"]);return o.default.createElement("svg",a({ref:t,xmlns:"http://www.w3.org/2000/svg",width:i,height:i,viewBox:"0 0 24 24",fill:"none",stroke:void 0===n?"currentColor":n,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},l),o.default.createElement("path",{d:"M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"}),o.default.createElement("circle",{cx:"12",cy:"7",r:"4"}))});d.propTypes={color:l.default.string,size:l.default.oneOfType([l.default.string,l.default.number])},d.displayName="User";var s=e.i(95944),c=e.i(43174),h=e.i(88526),p=e.i(39646);e.i(43366);var f=e.i(41592);function u(){return(u=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}var g=(0,o.forwardRef)(function(e,t){var n=e.color,r=e.size,i=void 0===r?24:r,l=function(e,t){if(null==e)return{};var n,r,i=function(e,t){if(null==e)return{};var n,r,i={},o=Object.keys(e);for(r=0;r<o.length;r++)n=o[r],t.indexOf(n)>=0||(i[n]=e[n]);return i}(e,t);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);for(r=0;r<o.length;r++)n=o[r],!(t.indexOf(n)>=0)&&Object.prototype.propertyIsEnumerable.call(e,n)&&(i[n]=e[n])}return i}(e,["color","size"]);return o.default.createElement("svg",u({ref:t,xmlns:"http://www.w3.org/2000/svg",width:i,height:i,viewBox:"0 0 24 24",fill:"none",stroke:void 0===n?"currentColor":n,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},l),o.default.createElement("path",{d:"M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"}),o.default.createElement("path",{d:"M13.73 21a2 2 0 0 1-3.46 0"}))});g.propTypes={color:l.default.string,size:l.default.oneOfType([l.default.string,l.default.number])},g.displayName="Bell";let x=(0,f.observer)(function(){return(0,t.jsxs)(m,{children:[(0,t.jsx)(g,{size:20}),c.default.notification.unreads.length>0&&(0,t.jsx)(y,{})]})}),{SECONDARY:b}=i.default.color,m=r.default.div.withConfig({componentId:"zh__sc-b0e7adc5-0"})`
  ...
  position: relative;
  cursor: pointer;
`,y=r.default.div.withConfig({componentId:"zh__sc-b0e7adc5-1"})`
  width: 8px;
  height: 8px;
  border-radius: 8px;
  ...
  top: 4px;
  right: 4px;
`;function w({isHomePage:e}){return(0,t.jsxs)(I,{children:[e&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(k,{children:(0,t.jsx)(p.Body1,{$weight:"BOLD",children:"사용자전환"})}),(0,t.jsx)(E,{children:(0,t.jsx)(p.Body1,{$weight:"BOLD",children:"챗봇"})}),(0,t.jsx)(D,{children:(0,t.jsx)(p.Body1,{$weight:"BOLD",children:"원격지원"})}),(0,t.jsx)(T,{children:(0,t.jsx)(p.Body1,{$weight:"BOLD",children:"음성알림"})}),(0,t.jsx)(L,{children:(0,t.jsx)(p.Body1,{$weight:"BOLD",children:"기관운영"})}),(0,t.jsx)(M,{onClick:()=>c.default.auth.logout(),children:(0,t.jsx)(p.Body1,{$weight:"BOLD",children:"로그아웃"})})]}),(0,t.jsxs)(S,{children:[(0,t.jsx)(s.Search,{size:17}),(0,t.jsx)(A,{name:"search",placeholder:"텍스트 입력..."})]}),(0,t.jsx)(x,{}),(0,t.jsx)(p.Body1,{$weight:"MEDIUM",children:"김요한 복지사"}),(0,t.jsx)(R,{children:(0,t.jsx)(d,{size:20,className:h.default.classname.CLICKABLE})})]})}let{SPACING:j,BORDER_RADIUS:v}=i.default.numeric,{PRIMARY:O,SECONDARY:_,GREEN:z,ORANGE:C,BLACK:$}=i.default.color,I=r.default.div.withConfig({componentId:"zh__sc-fea378dc-0"})`
  height: 64px;
  display: flex;
  align-items: center;
  gap: ${j.MEDIUM}px;
...
`,P=r.default.button.withConfig({componentId:"zh__sc-fea378dc-1"})`
  width: 110px;
  height: 40px;
  color: white;
  border: none;
  border-radius: ${v}px;
  cursor: pointer;
`,k=(0,r.default)(P).withConfig({componentId:"zh__sc-fea378dc-2"})`
  background-color: ${O[80]};
  opacity: 0.6;
`,E=(0,r.default)(P).withConfig({componentId:"zh__sc-fea378dc-3"})`
  background-color: ${O[100]};
`,D=(0,r.default)(P).withConfig({componentId:"zh__sc-fea378dc-4"})`
  background-color: ${_[100]};
`,T=(0,r.default)(P).withConfig({componentId:"zh__sc-fea378dc-5"})`
  background-color: ${z[100]};
`,L=(0,r.default)(P).withConfig({componentId:"zh__sc-fea378dc-6"})`
  background-color: ${C[100]};
`,M=(0,r.default)(P).withConfig({componentId:"zh__sc-fea378dc-7"})`
  background-color: ${$[70]};
...
`,B=(0,f.observer)(function(){let{mainDataUpdatedAt:e,updateMainDataUpdatedAt:n}=c.default.time;return(0,o.useEffect)(()=>n(),[n]),(0,t.jsxs)(W,{children:[(0,t.jsx)(p.Body2,{$weight:"REGULAR",children:`메인데이터 최근 반영 일자 ${e}`}),(0,t.jsx)(H,{onClick:n,children:(0,t.jsx)(p.Body3,{$weight:"MEDIUM",children:"갱신"})})]})}),{BLACK:U}=i.default.color,{SPACING:N,BORDER_RADIUS:G}=i.default.numeric,{BOX_SHADOW:F}=i.default.text,W=r.default.div.withConfig({componentId:"zh__sc-d50d07d8-0"})`
  display: flex;
  align-items: center;
  gap: ${N.LARGE}px;
...
`,X=[{subpath:"/recipient",label:"수급자관리",hasPage:!1,icon:(0,t.jsx)(m.Users,{size:16}),children:[{subpath:"/info",label:"수급자정보 관리",hasPage:!0,children:[{subpath:"/waiting",label:"대기 수급자 관리",hasPage:!1}]},{subpath:"1-2 // TODO:",label:"수급자 정보(공단연동)",hasPage:!1},{subpath:"1-3 // TODO:",label:"전체 기초평가 현황",hasPage:!1},{subpath:"1-4 // TODO:",label:"기초평가 관리",hasPage:!1},{subpath:"1-5 // TODO:",label:"상담일지",hasPage:!1},{subpath:"/family-letter",label:"가정통신문",hasPage:!0},{subpath:"1-7 // TODO:",label:"수급자 안전관리 설명",hasPage:!1},{subpath:"1-8 // TODO:",label:"수급자 현황 리스트",hasPage:!1},{subpath:"1-9 // TODO:",label:"수급자 월별 통계 리스트",hasPage:!1},{subpath:"1-10 // TODO:",label:"수급자 등급 변동 현황",hasPage:!1}]},{subpath:"/2 // TODO:",label:"이동서비스",hasPage:!1,icon:(0,t.jsx)(a,{size:16}),children:[{subpath:"2-1 // TODO:",label:"현장관리",hasPage:!1},{subpath:"2-2 // TODO:",label:"출석관리(차량 미이용)",hasPage:!1},{subpath:"2-3 // TODO:",label:"출석관리(차량 이용)",hasPage:!1},{subpath:"2-4 // TODO:",label:"차량관리",hasPage:!1},{subpath:"2-5 // TODO:",label:"청구내역상세",hasPage:!1},{subpath:"2-6 // TODO:",label:"공단 급여비용 청구자료(공단연동)",hasPage:!1},{subpath:"2-7 // TODO:",label:"월간 서비스변동현황",hasPage:!1},{subpath:"2-8 // TODO:",label:"월간 일수자 현황",hasPage:!1},{subpath:"2-9 // TODO:",label:"수급자 외출 현황 리스트",hasPage:!1}]},{subpath:"/3 // TODO:",label:"요양급여제공",hasPage:!1,icon:(0,t.jsx)(h.Heart,{size:16}),children:[{subpath:"3-1 // TODO:",label:"요양급여 제공 기록",hasPage:!1},{subpath:"3-2 // TODO:",label:"상태변화 기록",hasPage:!1},{subpath:"3-3 // TODO:",label:"목욕일정(2021.4)",hasPage:!1},{subpath:"3-4 // TODO:",label:"구강관리 리스트",hasPage:!1},{subpath:"3-5 // TODO:",label:"복약 도움 리스트 (완)",hasPage:!1},{subpath:"3-6 // TODO:",label:"급여제공 기록지 리스트",hasPage:!1}]},{subpath:"/4 // TODO:",label:"간호/물리 급여제공",hasPage:!1,icon:(0,t.jsx)(o,{size:16}),children:[{subpath:"4-1 // TODO:",label:"간호 급여 제공기록 (완)",hasPage:!1},{subpath:"4-2 // TODO:",label:"물리(작업)치료 제공기록",hasPage:!1},{subpath:"4-3 // TODO:",label:"물리(작업)치료 평가 및 계획",hasPage:!1},{subpath:"4-4 // TODO:",label:"응급상황기록 (완)",hasPage:!1},{subpath:"4-5 // TODO:",label:"통합 간호제공 리스트",hasPage:!1},{subpath:"4-6 // TODO:",label:"법외인 전문내역 리스트",hasPage:!1},{subpath:"4-7 // TODO:",label:"투약제공 리스트 (완)",hasPage:!1},{subpath:"4-8 // TODO:",label:"물리(작업)치료 제공 리스트",hasPage:!1}]},{subpath:"/5 // TODO:",label:"프로그램급여제공",hasPage:!1,icon:(0,t.jsx)(y.Play,{size:16}),children:[{subpath:"5-1 // TODO:",label:"입주+행정지(재배)",hasPage:!1},{subpath:"5-2 // TODO:",label:"프로그램 계획서",hasPage:!1},{subpath:"5-3 // TODO:",label:"수급자 참여프로그램 리스트",hasPage:!1},{subpath:"5-4 // TODO:",label:"프로그램 제공기록 현황",hasPage:!1},{subpath:"5-5 // TODO:",label:"그룹 설정 이력 리스트",hasPage:!1},{subpath:"5-6 // TODO:",label:"프로그램 일정 리스트",hasPage:!1},{subpath:"5-7 // TODO:",label:"프로그램 계획 리스트",hasPage:!1}]},{subpath:"/6 // TODO:",label:"위생/안전 점검관리",hasPage:!1,icon:(0,t.jsx)(y.ShieldDone,{size:16}),children:[{subpath:"6-1 // TODO:",label:"간식단표",hasPage:!1},{subpath:"6-2 // TODO:",label:"일일점검",hasPage:!1},{subpath:"6-3 // TODO:",label:"정기점검",hasPage:!1},{subpath:"6-4 // TODO:",label:"시설운영일지",hasPage:!1}]},{subpath:"/7 // TODO:",label:"본인 부담금관리",hasPage:!1,icon:(0,t.jsx)(s,{size:16}),children:[{subpath:"7-1 // TODO:",label:"본인부담금 청구관리",hasPage:!1},{subpath:"7-2 // TODO:",label:"본인부담금 입금관리",hasPage:!1},{subpath:"7-3 // TODO:",label:"본인부담금 미납관리",hasPage:!1},{subpath:"7-4 // TODO:",label:"청구서식 글씨설정",hasPage:!1},{subpath:"7-5 // TODO:",label:"연간 청구대장 리포트",hasPage:!1},{subpath:"7-6 // TODO:",label:"월별 입금대장",hasPage:!1},{subpath:"7-7 // TODO:",label:"월별 수납대장 리포트",hasPage:!1},{subpath:"7-8 // TODO:",label:"본인부담금 수납내역",hasPage:!1}]},{subpath:"/8 // TODO:",label:"직원관리",hasPage:!1,icon:(0,t.jsx)(b,{size:16}),children:[{subpath:"8-1 // TODO:",label:"직원정보 관리",hasPage:!1},{subpath:"8-2 // TODO:",label:"근무일정표",hasPage:!1},{subpath:"8-3 // TODO:",label:"연간 일정관리",hasPage:!1},{subpath:"8-4 // TODO:",label:"출퇴근 및 근무관리",hasPage:!1},{subpath:"8-5 // TODO:",label:"사례관리 회의록",hasPage:!1},{subpath:"8-6 // TODO:",label:"회의록(보호자/표상)",hasPage:!1},{subpath:"8-7 // TODO:",label:"교육일지(인권/재난)",hasPage:!1},{subpath:"8-8 // TODO:",label:"자원봉사자 활동일지",hasPage:!1},{subpath:"8-9 // TODO:",label:"고충처리 관리",hasPage:!1},{subpath:"8-10 // TODO:",label:"현황 리포트",hasPage:!1},{subpath:"8-11 // TODO:",label:"연차대장",hasPage:!1}]},{subpath:"/9 // TODO:",label:"기초설정 및 운영관리",hasPage:!1,icon:(0,t.jsx)(g,{size:16}),children:[{subpath:"9-1 // TODO:",label:"시설정보설정",hasPage:!1},{subpath:"9-2 // TODO:",label:"운영급여 수가설정",hasPage:!1},{subpath:"9-3 // TODO:",label:"이용요금 결제 및 안장",hasPage:!1},{subpath:"9-4 // TODO:",label:"연간 부담금협정",hasPage:!1}]},{subpath:"/10 // TODO:",label:"부가서비스",hasPage:!1,icon:(0,t.jsx)(f,{size:16}),children:[{subpath:"10-1 // TODO:",label:"문자메시지 발송",hasPage:!1},{subpath:"10-2 // TODO:",label:"급여계좌 바뀜 안내 발송",hasPage:!1},{subpath:"10-3 // TODO:",label:"보조기 급여기록 엑셀내역",hasPage:!1},{subpath:"10-4 // TODO:",label:"자동실",hasPage:!1},{subpath:"10-5 // TODO:",label:"홈페이지 서비스",hasPage:!1},{subpath:"10-6 // TODO:",label:"보조기 엑셀 관리 (완)",hasPage:!1},{subpath:"10-7 // TODO:",label:"PDF 백업서비스",hasPage:!1},{subpath:"10-8 // TODO:",label:"인내발송내역",hasPage:!1},{subpath:"10-9 // TODO:",label:"평가항목 일괄 출력",hasPage:!1}]},{subpath:"/11 // TODO:",label:"직원 급여관리",hasPage:!1,icon:(0,t.jsx)(c.FileText,{size:16}),children:[{subpath:"11-1 // TODO:",label:"월별 급여대장",hasPage:!1},{subpath:"11-2 // TODO:",label:"퇴직적립금 관리",hasPage:!1},{subpath:"11-3 // TODO:",label:"직원 급여계정 설정",hasPage:!1},{subpath:"11-4 // TODO:",label:"급여기준 설정",hasPage:!1},{subpath:"11-5 // TODO:",label:"인건비 지출내용 자료",hasPage:!1},{subpath:"11-6 // TODO:",label:"직원 연간 급여대장",hasPage:!1}]}];e.s(["default",0,function(){return(0,t.jsx)(K,{children:(0,t.jsx)(G,{routes:X})})}],33492)},48647,83951,e=>{"use strict";var t=e.i(7744);let n=["Escape","Enter"," ","Tab","Backspace","Delete","ArrowUp","ArrowDown","ArrowLeft","ArrowRight"];e.s(["default",0,function(e,r=!0){let i=(0,t.useRef)(e);(0,t.useEffect)(()=>{i.current=e},[e]),(0,t.useEffect)(()=>{if(!r)return;let e=e=>{let t;if(t=e.key,!n.includes(t))return;let r=i.current[e.key];r&&r()};return window.addEventListener("keydown",e),()=>{window.removeEventListener("keydown",e)}},[r])}],48647);var r=e.i(9735),i=e.i(12235);let{Z_INDEX:o}=e.i(65234).default.numeric,l=i.default.div.withConfig({componentId:"zh__sc-2034f91d-0"})`
  ...
  z-index: ${o.MODAL};
`;e.s(["default",0,function({children:e}){return(0,t.useEffect)(()=>{let e=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=e}},[]),(0,r.jsx)(l,{children:e})}],83951)},53919,e=>{"use strict";var t=e.i(9735);e.i(43366);var n=e.i(41592),r=e.i(7665),i=e.i(7744),o=e.i(12235),l=e.i(25521),a=e.i(48647),d=e.i(43174),s=e.i(83951);let c=(0,n.observer)(function(){let{fileSelectModalConfig:e,closeFileSelectModal:n}=d.default.modal,o=(0,i.useRef)(null);if((0,a.default)({Escape:n},null!==e),!e)return null;let c=()=>n();return(0,t.jsx)(s.default,{children:(0,t.jsxs)(h,{children:[(0,t.jsxs)(p,{children:[(0,t.jsx)(f,{children:e.title}),(0,t.jsx)(u,{children:(0,t.jsx)(g,{onClick:c,children:(0,t.jsx)(r.default,{src:`${l.default.env.PUBLIC_PATH}/img/x.svg`,width:1,height:1,style:{width:"100%",height:"100%"},alt:"x"})})})]}),(0,t.jsxs)(x,{onClick:()=>o.current?.click(),onDragOver:e=>e.preventDefault(),onDrop:e=>{e.preventDefault(),o.current&&(o.current.files=e.dataTransfer.files)},children:[(0,t.jsx)(b,{children:(0,t.jsx)(r.default,{src:`${l.default.env.PUBLIC_PATH}/img/download.svg`,width:1,height:1,style:{width:40,height:40},alt:"download"})}),(0,t.jsx)(m,{children:"클릭 혹은 파일을 이곳에 드롭하세요."}),(0,t.jsx)(y,{children:"파일당 최대 3MB"})]}),(0,t.jsxs)(w,{children:[(0,t.jsx)(j,{onClick:c,children:"취소"}),(0,t.jsx)(v,{onClick:c,children:"확인"})]}),(0,t.jsx)("input",{style:{display:"none"},ref:o,type:"file"})]})})}),h=o.default.div.withConfig({componentId:"zh__sc-8becc200-0"})`
  width: 500px;
  height: 442px;
  display: flex;
...
`,p=o.default.div.withConfig({componentId:"zh__sc-8becc200-1"})`
  width: 100%;
  height: 57px;
  padding: 0 24px;
  display: flex;
...
`,f=o.default.div.withConfig({componentId:"zh__sc-8becc200-2"})`
  color: #1e2939;
  font-size: 16px;
  font-weight: 700;
  letter-spacing: -0.312px;
`,u=o.default.div.withConfig({componentId:"zh__sc-8becc200-3"})``,g=o.default.button.withConfig({componentId:"zh__sc-8becc200-4"})`
  display: flex;
  justify-content: center;
  align-items: center;
  background: none;
  border: none;
`,x=o.default.div.withConfig({componentId:"zh__sc-8becc200-5"})`
  width: calc(100% - 48px);
  flex: 1;
  display: flex;
  flex-direction: column;
  ...
  background: #fff;
  margin: 24px;
`,b=o.default.div.withConfig({componentId:"zh__sc-8becc200-6"})`
  width: 80px;
  height: 80px;
  display: flex;
  justify-content: center;
  ...
  border-radius: 16px;
  background: #000;
`,m=o.default.div.withConfig({componentId:"zh__sc-8becc200-7"})`
  color: #1e2939;
  text-align: center;
  font-size: 14px;
  font-weight: 400;
  ...
  margin-top: 16px;
`,y=o.default.div.withConfig({componentId:"zh__sc-8becc200-8"})`
  color: #6a7282;
  text-align: center;
  font-size: 12px;
  font-weight: 400;
  margin-top: 5px;
`,w=o.default.div.withConfig({componentId:"zh__sc-8becc200-9"})`
  width: 100%;
  height: 70px;
  display: flex;
  justify-content: end;
...
`,j=o.default.button.withConfig({componentId:"zh__sc-8becc200-10"})`
  width: 66px;
  height: 37px;
  border-radius: 10px;
  ...
  font-weight: 500;
  letter-spacing: -0.15px;
`,v=(0,o.default)(j).withConfig({componentId:"zh__sc-8becc200-11"})`
  color: white;
  background: #4f39f6;
`;e.s(["default",0,c])},8179,e=>{"use strict";var t=e.i(7744),n=e.i(4153);function r(){return(r=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}var i=(0,t.forwardRef)(function(e,n){var i=e.color,o=e.size,l=void 0===o?24:o,a=function(e,t){if(null==e)return{};var n,r,i=function(e,t){if(null==e)return{};var n,r,i={},o=Object.keys(e);for(r=0;r<o.length;r++)n=o[r],t.indexOf(n)>=0||(i[n]=e[n]);return i}(e,t);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);for(r=0;r<o.length;r++)n=o[r],!(t.indexOf(n)>=0)&&Object.prototype.propertyIsEnumerable.call(e,n)&&(i[n]=e[n])}return i}(e,["color","size"]);return t.default.createElement("svg",r({ref:n,xmlns:"http://www.w3.org/2000/svg",width:l,height:l,viewBox:"0 0 24 24",fill:"none",stroke:void 0===i?"currentColor":i,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},a),t.default.createElement("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),t.default.createElement("line",{x1:"6",y1:"6",x2:"18",y2:"18"}))});i.propTypes={color:n.default.string,size:n.default.oneOfType([n.default.string,n.default.number])},i.displayName="X",e.s(["X",0,i],8179)},94030,e=>{"use strict";var t=e.i(9735);e.i(43366);var n=e.i(41592),r=e.i(8179),i=e.i(12235),o=e.i(48647),l=e.i(43174),a=e.i(88526),d=e.i(39646),s=e.i(86400),c=e.i(83951);let{ssn2masked:h}=s.default.convert,p=(0,n.observer)(function(){let{nameTypoFixModalConfig:e,nameTypoFixModalData:n,closeNameTypoFixModal:i,setNameTypoFixPhase:s,setNameTypoFixSelectedName:p}=l.default.modal;if((0,o.default)({Escape:i},null!==e),!e||!n)return null;let{contractDate:f,contractNumber:u,admissionDate:g,contractPeriodYears:x,recipient:b,guardian:eb,content:em,phase:ey,selectedName:ew}=n;return(0,t.jsx)(c.default,{children:(0,t.jsxs)(m,{children:[(0,t.jsxs)(y,{children:[(0,t.jsxs)(w,{children:[(0,t.jsx)(d.Subtitle1,{$weight:"BOLD",children:"입소 계약서"}),(0,t.jsx)(j,{children:"이름 오타 확인 필요"})]}),(0,t.jsx)(v,{children:(0,t.jsx)(r.X,{size:20,color:"#6A7282",onClick:i,className:a.default.classname.CLICKABLE})})]}),(0,t.jsxs)(O,{children:[0===ey&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(_,{children:[(0,t.jsxs)(z,{children:[(0,t.jsxs)(C,{children:[(0,t.jsx)($,{children:"계약일:"}),(0,t.jsx)(I,{children:f})]}),(0,t.jsxs)(C,{children:[(0,t.jsx)($,{children:"계약번호:"}),(0,t.jsx)(I,{children:u})]})]}),(0,t.jsxs)(z,{children:[(0,t.jsxs)(C,{children:[(0,t.jsx)($,{children:"입소일:"}),(0,t.jsx)(I,{children:g})]}),(0,t.jsxs)(C,{children:[(0,t.jsx)($,{children:"계약기간:"}),(0,t.jsxs)(I,{children:[x,"년"]})]})]})]}),(0,t.jsxs)(P,{children:[(0,t.jsxs)(k,{children:[(0,t.jsx)(E,{}),(0,t.jsx)(D,{children:"수급자 정보"})]}),(0,t.jsx)(T,{children:(0,t.jsxs)("tbody",{children:[(0,t.jsxs)(L,{children:[(0,t.jsx)(M,{children:"성명"}),(0,t.jsxs)(S,{children:[(0,t.jsxs)(R,{children:[(0,t.jsx)(A,{children:b.contractName}),(0,t.jsx)(A,{children:"← 계약서 원본"})]}),(0,t.jsxs)(R,{children:[(0,t.jsx)(A,{children:b.systemName}),(0,t.jsx)(A,{children:(0,t.jsx)(d.Body3,{$weight:"REGULAR",children:"시스템 입력값 (불일치)"})})]})]})]}),(0,t.jsxs)(L,{children:[(0,t.jsx)(M,{children:"주민등록번호"}),(0,t.jsx)(S,{children:h(b.socialSecurityNumber)})]}),(0,t.jsxs)(L,{children:[(0,t.jsx)(M,{children:"주소"}),(0,t.jsx)(S,{children:b.address})]}),(0,t.jsxs)(L,{children:[(0,t.jsx)(M,{children:"연락처"}),(0,t.jsx)(S,{children:b.contact})]})]})})]}),(0,t.jsxs)(B,{children:[(0,t.jsxs)(k,{children:[(0,t.jsx)(E,{}),(0,t.jsx)(D,{children:"보호자 정보"})]}),(0,t.jsx)(T,{children:(0,t.jsxs)("tbody",{children:[(0,t.jsxs)(L,{children:[(0,t.jsx)(M,{children:"성명"}),(0,t.jsx)(S,{children:eb.name})]}),(0,t.jsxs)(L,{children:[(0,t.jsx)(M,{children:"관계"}),(0,t.jsx)(S,{children:eb.relationship})]}),(0,t.jsxs)(L,{children:[(0,t.jsx)(M,{children:"주소"}),(0,t.jsx)(S,{children:eb.address})]}),(0,t.jsxs)(L,{children:[(0,t.jsx)(M,{children:"연락처"}),(0,t.jsx)(S,{children:eb.contact})]})]})})]}),(0,t.jsxs)(U,{children:[(0,t.jsxs)(k,{children:[(0,t.jsx)(E,{}),(0,t.jsx)(D,{children:"계약 내용"})]}),(0,t.jsx)(N,{children:em.map(({style:e,text:n},r)=>(0,t.jsx)(G,{style:{...e},children:n},`${r}-${n}`))})]}),(0,t.jsx)(F,{children:(0,t.jsx)(W,{children:(0,t.jsxs)(H,{children:[(0,t.jsxs)(K,{children:[(0,t.jsx)(X,{children:"수급자 (입소자)"}),(0,t.jsx)(V,{children:(0,t.jsxs)(q,{children:["성명: ",(0,t.jsx)(J,{children:b.contractName})," (인)"]})})]}),(0,t.jsxs)(K,{children:[(0,t.jsx)(X,{children:"보호자"}),(0,t.jsx)(V,{children:(0,t.jsxs)(q,{children:["성명: ",(0,t.jsx)(J,{children:eb.name})," (인)"]})})]})]})})})]}),1===ey&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(er,{children:[(0,t.jsx)(d.Subtitle1,{$weight:"BOLD",children:"올바른 이름을 선택해주세요"}),(0,t.jsx)(d.Body1,{$weight:"REGULAR",children:"아래에서 올바른 이름을 선택하시면 자동으로 시스템이 수정됩니다"})]}),(0,t.jsxs)(ei,{children:[(0,t.jsxs)(eo,{selected:"contract"===ew,onClick:()=>p("contract"),children:[(0,t.jsx)(el,{children:(0,t.jsx)(ea,{selected:"contract"===ew})}),(0,t.jsxs)(ed,{children:[(0,t.jsxs)(es,{children:[(0,t.jsx)(ec,{children:b.contractName}),(0,t.jsx)(eh,{children:"계약서 원본"})]}),(0,t.jsxs)(ef,{children:['계약서에 서명된 이름입니다. 이 이름이 올바르다면 시스템 데이터가 "',b.contractName,'"로 수정됩니다.']})]})]}),(0,t.jsxs)(eo,{selected:"system"===ew,onClick:()=>p("system"),children:[(0,t.jsx)(el,{children:(0,t.jsx)(ea,{selected:"system"===ew})}),(0,t.jsxs)(ed,{children:[(0,t.jsxs)(es,{children:[(0,t.jsx)(ec,{children:b.systemName}),(0,t.jsx)(ep,{children:"시스템 입력값"})]}),(0,t.jsx)(ef,{children:"현재 시스템에 등록된 이름입니다. 이 이름이 올바르다면 계약서 재작성 요청이 접수됩니다."})]})]})]}),(0,t.jsx)(eu,{children:(0,t.jsx)(eg,{children:(0,t.jsxs)(ex,{children:[(0,t.jsx)("span",{style:{fontWeight:500},children:"주의:"})," 선택한 이름으로 모든 관련 문서와 시스템이 업데이트됩니다. 신중하게 선택해주세요."]})})})]})]}),(0,t.jsxs)(Q,{children:[0===ey&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(Y,{children:"계약서 원본은 시설 보관함에 보관 중입니다"}),(0,t.jsxs)(Z,{children:[(0,t.jsx)(ee,{onClick:i,children:"닫기"}),(0,t.jsx)(et,{onClick:()=>s(1),children:"이름 수정 요청"})]})]}),1===ey&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(Y,{}),(0,t.jsxs)(Z,{children:[(0,t.jsx)(ee,{onClick:()=>s(0),children:"이전"}),(0,t.jsx)(en,{disabled:!ew,onClick:i,children:"수정 요청 접수"})]})]})]})]})})}),{BORDER_RADIUS:f,SPACING:u}=a.default.consts.numeric,{BLACK:g,PRIMARY:x,SECONDARY:b}=a.default.consts.color,m=i.default.div.withConfig({componentId:"zh__sc-d20e784d-0"})`
  width: 800px;
  ...
  border-radius: ${f}px;
  overflow: hidden;
`,y=i.default.div.withConfig({componentId:"zh__sc-d20e784d-1"})`
  height: 60px;
  flex-shrink: 0;
  display: flex;
  justify-content: space-between;
  ...
  background: ${g[10]};
  border-bottom: 0.75px solid #e5e7eb;
`,w=i.default.div.withConfig({componentId:"zh__sc-d20e784d-2"})`
  display: flex;
  align-items: center;
  gap: ${u.MEDIUM}px;
...
`,C=i.default.div.withConfig({componentId:"zh__sc-d20e784d-8"})`
  flex: 1;
  display: flex;
`,$=i.default.div.withConfig({componentId:"zh__sc-d20e784d-9"})`
  font-size: 14px;
  color: ${g[70]};
`,I=(0,i.default)($).withConfig({componentId:"zh__sc-d20e784d-10"})`
  color: black;
  font-weight: 500;
`,P=i.default.div.withConfig({componentId:"zh__sc-d20e784d-11"})`
  display: flex;
  flex-direction: column;
  gap: 12px;
`,k=i.default.div.withConfig({componentId:"zh__sc-d20e784d-12"})`
  display: flex;
  align-items: center;
  gap: ${u.MEDIUM}px;
...
`,eh=i.default.div.withConfig({componentId:"zh__sc-d20e784d-47"})`
  ...
  line-height: 16px;
  padding: 4px 8px;
`,ep=(0,i.default)(eh).withConfig({componentId:"zh__sc-d20e784d-48"})`
  color: #bb4d00;
  border: 0.75px solid #fee685;
  background: #fef3c6;
`,ef=i.default.div.withConfig({componentId:"zh__sc-d20e784d-49"})`
  color: #4a5565;
  font-family: Inter;
  font-size: 14px;
  font-style: normal;
...
`,ex=i.default.p.withConfig({componentId:"zh__sc-d20e784d-52"})`
  ...
  font-size: 12px;
  line-height: 1.5;
`;e.s(["default",0,p])},38126,e=>{"use strict";var t=e.i(9735);e.i(43366);var n=e.i(41592),r=e.i(7665),i=e.i(54946),o=e.i(8179),l=e.i(12235),a=e.i(25521),d=e.i(48647),s=e.i(43174),c=e.i(88526),h=e.i(39646),p=e.i(83951);let f=(0,n.observer)(function(){let{roomAssignModalConfig:e,roomAssignModalData:n,closeRoomAssignModal:l,setSelectedRoomId:f}=s.default.modal;if((0,d.default)({Escape:l},null!==e),!e||!n)return null;let{recipient:u,rooms:g,selectedRoomId:x}=n,{name:b,gender:m,age:Z}=u,ee=g.filter(e=>e.gender===m);return(0,t.jsx)(p.default,{children:(0,t.jsxs)(y,{children:[(0,t.jsxs)(w,{children:[(0,t.jsxs)(j,{children:[(0,t.jsx)(r.default,{src:`${a.default.env.PUBLIC_PATH}/img/bed.svg`,width:20,height:20,alt:"icon"}),(0,t.jsx)(h.Subtitle1,{$weight:"BOLD",children:"생활실 배정"}),(0,t.jsx)(v,{children:`${b} (${"MALE"===m?"남":"여"}, ${Z}세)`})]}),(0,t.jsx)(O,{children:(0,t.jsx)(o.X,{size:20,color:"#6A7282",onClick:l,className:c.default.classname.CLICKABLE})})]}),(0,t.jsxs)(_,{children:[(0,t.jsxs)(z,{children:[(0,t.jsx)(h.Body3,{$weight:"BOLD",children:"수급자 성별: "}),(0,t.jsxs)(h.Body3,{$weight:"REGULAR",children:["MALE"===m?"남성":"여성"," → ","MALE"===m?"남성":"여성"," 전용 생활실만 표시됩니다"]})]}),(0,t.jsx)(C,{children:ee.map(e=>{let n=e.residents.length,r=Math.max(e.capacity-n,0),o=Math.min(n/e.capacity*100,100),l=x===e.id;return(0,t.jsxs)($,{type:"button",disabled:0===r,$isFull:0===r,$isSelected:l,onClick:()=>f(e.id),children:[(0,t.jsxs)(I,{children:[(0,t.jsxs)(P,{children:[(0,t.jsx)(k,{$isFull:0===r,$isSelected:l,children:l&&r>0&&(0,t.jsx)(E,{})}),(0,t.jsxs)(D,{children:[(0,t.jsx)(T,{children:e.name}),(0,t.jsx)(L,{children:"MALE"===e.gender?"남성 전용":"여성 전용"})]})]}),(0,t.jsx)(M,{children:(0,t.jsx)(S,{$isFull:0===r,children:0===r?"만실":`${r}자리 가능`})})]}),(0,t.jsxs)(A,{children:[(0,t.jsx)(i.Users,{size:16}),(0,t.jsx)(R,{children:(0,t.jsx)(B,{$isFull:0===r,style:{width:`${o}%`}})}),(0,t.jsx)(U,{children:`${n}/${e.capacity}명`})]}),(0,t.jsxs)(N,{$isBorderBold:0===r||l,children:[(0,t.jsx)(G,{children:"현재 입소자"}),(0,t.jsxs)(F,{children:[e.residents.map(e=>(0,t.jsxs)(W,{$isFull:0===r,children:[(0,t.jsx)(H,{children:e.name}),(0,t.jsx)(K,{children:`${e.age}세`})]},e.id)),Array.from({length:r}).map((n,r)=>(0,t.jsx)(X,{children:"빈 자리"},`empty-${e.id}-${r}`))]})]})]},e.id)})})]}),(0,t.jsxs)(V,{children:[(0,t.jsx)(q,{children:null!==x&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(r.default,{src:`${a.default.env.PUBLIC_PATH}/img/check-circle.svg`,width:16,height:16,alt:"icon"})," ","생활실을 선택했습니다"]})}),(0,t.jsxs)(J,{children:[(0,t.jsx)(Q,{onClick:l,children:"취소"}),(0,t.jsx)(Y,{disabled:null===x,onClick:l,children:"배정하기"})]})]})]})})}),{BORDER_RADIUS:u,SPACING:g}=c.default.consts.numeric,{BLACK:x,PRIMARY:b,SECONDARY:m}=c.default.consts.color,y=l.styled.div.withConfig({componentId:"zh__sc-479b1000-0"})`
  width: 800px;
  max-height: min(100%, 1021px);
  display: flex;
  flex-direction: column;
  border-radius: ${u}px;
  overflow: hidden;
`,w=l.styled.div.withConfig({componentId:"zh__sc-479b1000-1"})`
  height: 60px;
  flex-shrink: 0;
  display: flex;
  justify-content: space-between;
...
`,C=l.styled.div.withConfig({componentId:"zh__sc-479b1000-7"})`
  ...
  flex-direction: column;
  gap: ${g.MEDIUM}px;
`,$=l.styled.button.withConfig({componentId:"zh__sc-479b1000-8"})`
  width: 100%;
  border: 2px solid
...
`,I=l.styled.div.withConfig({componentId:"zh__sc-479b1000-9"})`
  display: flex;
  justify-content: space-between;
  align-items: flex-start;
  margin-bottom: ${g.MEDIUM}px;
`,P=l.styled.div.withConfig({componentId:"zh__sc-479b1000-10"})`
  display: flex;
  align-items: center;
  gap: ${g.MEDIUM}px;
`,k=l.styled.div.withConfig({componentId:"zh__sc-479b1000-11"})`
  width: 20px;
  height: 20px;
  display: flex;
  align-items: center;

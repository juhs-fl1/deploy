...
`,A=d.default.input.withConfig({displayName:"Search__Input",componentId:"sc-da95b10f-2"})`
  ...
  border: none;
  outline: none;
`;var k=e.i(88526);let T=(0,n.observer)(function(){let{searchedList:e,selectedId:n,setSelectedId:t}=l.default.recipient,{showNameTypoFixModal:d,showRoomAssignModal:o}=l.default.modal;return(0,i.jsx)(F,{children:(0,i.jsxs)(W,{children:[(0,i.jsx)(K,{children:(0,i.jsxs)("tr",{children:[(0,i.jsx)(Y,{style:{width:"15%"},children:"연번"}),(0,i.jsx)(Y,{style:{width:"20%"},children:"수급자명"}),(0,i.jsx)(Y,{style:{width:"15%"},children:"성"}),(0,i.jsx)(Y,{style:{width:"15%"},children:"나이"}),(0,i.jsx)(Y,{style:{width:"35%"},children:"생활실"})]})}),(0,i.jsx)(H,{children:e.map(({id:e,name:l,hasNameTypo:a,gender:s,age:r,room:c})=>{let f=e===n,x=null===c,h=a||x;return(0,i.jsxs)(V,{style:{color:h?B[100]:"inherit",backgroundColor:f?S[10]:h?B[10]:"inherit"},onClick:()=>t(e),children:[(0,i.jsx)(X,{children:e}),(0,i.jsxs)(X,{style:{color:f?S[100]:h?"inherit":z[100],fontWeight:U.MEDIUM},children:[l,a&&(0,i.jsx)(p.Caption3,{$weight:"MEDIUM",style:{display:"inline"},className:k.default.classname.CLICKABLE,onClick:()=>d({recipientId:e}),children:"(오타)"})]}),(0,i.jsx)(X,{children:"MALE"===s?"남":"여"}),(0,i.jsx)(X,{children:r}),(0,i.jsx)(X,{style:{color:x?"inherit":S[100],fontWeight:x?U.MEDIUM:"inherit"},children:x?(0,i.jsx)("span",{onClick:()=>o({recipientId:e}),className:k.default.classname.CLICKABLE,children:"미배정"}):c.name})]},e)})})]})})}),{PRIMARY:S,SECONDARY:B,BLACK:z}=o.default.color,{size:P,weight:U}=o.default.font,{SPACING:G}=o.default.numeric,F=d.default.div.withConfig({displayName:"Table__Wrapper",componentId:"sc-43376f1d-0"})`
  width: 100%;
  flex: 1;
  max-height: 677px;
  overflow: auto;
